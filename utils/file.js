...
const fileUtils = {
  ...
  /**
   * Gets files from database according to a query
   * to a parent id
   * @query {obj} query used to find file
  ...
  /**
   * Makes a file either public or private
   * @request {request_object} express request obj
  ...
  /**
   * Processes a file to be returned
  ...
  /**
   * Checks if a file is owned by user and public
  ...
  /**
   * Gets a file's data from database
